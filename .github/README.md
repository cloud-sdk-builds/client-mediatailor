...
[`@aws-sdk/client-mediatailor`](https://www.npmjs.com/package/@aws-sdk/client-mediatailor/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediatailor@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I+cTkDU9jeTjEIkbCjCCl2fI3Z1gndGxccnueVM+So2IbUUoNgm+EdLQnie/0Ckr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mediatailor": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediatailor@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediatailor@3.358.0/index.min.mjs": "sha384-I+cTkDU9jeTjEIkbCjCCl2fI3Z1gndGxccnueVM+So2IbUUoNgm+EdLQnie/0Ckr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mediatailor/blob/refs/tags/3.358.0/LICENSE
```
